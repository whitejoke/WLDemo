 ...
 * layout.
 */
public class SlidingTabLayoutTest extends HorizontalScrollView {
    /**
    ...
    /*获取 tab 每个 item 的信息*/
    private SlidingTabLayoutTest.TabItemName mItemName;
    ...
    public SlidingTabLayoutTest(Context context) {
        this(context, null);
    }

    public SlidingTabLayoutTest(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingTabLayoutTest(Context context, AttributeSet attrs, int defStyle) {

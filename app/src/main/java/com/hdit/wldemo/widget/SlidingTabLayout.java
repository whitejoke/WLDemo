        ...
        for (int i = 0; i < N; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.SlidingTabLayout_dividerWidth:
                    ...
                    break;
                case R.styleable.SlidingTabLayout_dividermatch:
                    dividermatch=typedArray.getBoolean(R.styleable.SlidingTabLayout_dividermatch,false);//DEFAULT_DIVIDER_MARGIN;
                    break;
            }
        }
        /*释放TypedArray*/
...
//        }
    ...
    private TextView createDefaultTabView(Context context) {
        TextView textV= (TextView) LayoutInflater.from(context).inflate(R.layout.sliding_textview,null);
       ...
       // textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, DEFAULT_TEXT_SIZE);
        ...
        int paddingL = (int) ((DEFAULT_TEXT_PADDING+10) * getResources().getDisplayMetrics().density);
        int paddingT = (int) (DEFAULT_TEXT_PADDING * getResources().getDisplayMetrics().density);
        int paddingR = (int) ((DEFAULT_TEXT_PADDING+10) * getResources().getDisplayMetrics().density);
        int paddingB = (int) (DEFAULT_TEXT_PADDING * getResources().getDisplayMetrics().density);
